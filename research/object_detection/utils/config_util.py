...
def get_graph_rewriter_config_from_file(graph_rewriter_config_file):
  ...
  with tf.compat.v1.gfile.GFile(graph_rewriter_config_file, "r") as f:
...
def save_pipeline_config(pipeline_config, directory):
  ...
  with tf.compat.v1.gfile.Open(pipeline_config_path, "wb") as f:
