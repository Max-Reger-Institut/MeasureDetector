...
def _run_checkpoint_once(tensor_dict,
  ...
  Args:
    ...
    variables_to_restore: None, or a dictionary mapping variable names found in
      ...
      generated by creating a tf.compat.v1.train.ExponentialMovingAverage object and
  ...
  if restore_fn:
    ...
    checkpoint_file = tf.compat.v1.train.latest_checkpoint(checkpoint_dirs[0])
...
def repeated_checkpoint_run(tensor_dict,
  ...
  while True:
    ...
    model_path = tf.compat.v1.train.latest_checkpoint(checkpoint_dirs[0])
    if not model_path:
