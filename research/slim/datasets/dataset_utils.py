...
def bytes_list_feature(values):
  ...
  Returns:
    A TF-Feature.
  """
  return tf.compat.v1.train.Feature(bytes_list=tf.compat.v1.train.BytesList(value=values))
...
def image_to_tfexample(image_data, image_format, height, width, class_id):
  return tf.compat.v1.train.Example(features=tf.compat.v1.train.Features(feature={
